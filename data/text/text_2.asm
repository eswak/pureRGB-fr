...
_WantToDepositText::
	text "Stocker dans le PC?"
	done

_DepositHowManyToPCText::
	text "Combien stocker"
	line "dans le PC?"
	done
...
_SaveFileUpdateText::
	text "Ce fichier de"
	line "sauvegarde semble"
	cont "venir d'une"
	cont "version antérieure"
	cont "du jeu."
	prompt

_SaveFileUpdateText2::
	text "De quelle version"
	line "antérieure vient-il?"
	done
...
_SaveFileUpdateCompleteText::
	text "Votre fichier de"
	line "sauvegarde a été"
	cont "mis à jour."
	done
